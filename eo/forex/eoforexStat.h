...
#ifndef _eoforexStat_h
#define _eoforexStat_h
 ...
 */
template <class EOT>
class eoforexStat : public eoStat<EOT, double>
{
public :
...
// START eventually add or modify the anyVariable argument
   ...
   */
  eoforexStat(std::string _description = "eoforexStat ") :
...
// END eventually add or modify the anyVariable argument
  ...
  virtual std::string className(void) const { return "eoforexStat"; }
private :
// START Private data of an eoforexStat object
  //  varType anyVariable;		   // for example ...
// END   Private data of an eoforexStat object
};
